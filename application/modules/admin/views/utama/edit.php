                ...
                <form action="<?= base_url('admin/utama') ?>" method="post">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="judul" class="form-control" value="<?= $utama->judul; ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-1">
                                <label for="" class="pull-right">Sambutan</label>
                            </div>
                            <div class="col-md-9">
                                <textarea name="deskripsi" class="form-control" id="editor1"><?= $utama->deskripsi ?></textarea>
                            </div>
                        </div>
                    </div>
