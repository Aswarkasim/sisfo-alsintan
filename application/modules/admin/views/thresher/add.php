                ...
                <form action="<?= base_url($add) ?>" method="post">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <input type="text" placeholder="Luas Panen" class="form-control" name="luas_panen">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <input type="text" placeholder="Produktivitas Gabah" class="form-control" name="produktivitas_gabah">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <input type="text" placeholder="Thresher Tersedia" class="form-control" name="tersedia">
                            </div>
                        </div>
                    </div>
