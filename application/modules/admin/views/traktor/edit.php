    ...
    <div class="col-md-6">
        <div class="box">
            ...
            <div class="box-body">
                ...
                <form action="<?= base_url($edit . $traktor->id_data) ?>" method="post">
                            ...
                            <div class="col-md-9">
                                <select name="id_kecamatan" required class="form-control select2" id="">
                                    ...
                                    <?php foreach ($kecamatan as $row) { ?>
                                        <option value="<?= $row->id_kecamatan; ?>" <?= ($row->id_kecamatan == $traktor->id_kecamatan) ? 'selected' : ''; ?>><?= $row->nama_kecamatan; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="col-md-9">
                                <select name="tahun" class="form-control select2">
                                    ...
                                    <?php for ($i = 2017; $i <= 2024; $i++) { ?>
                                        <option value="<?= $i; ?>" <?= ($i == $traktor->tahun) ? 'selected' : ''; ?>><?= $i; ?></option>
                                    <?php } ?>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <input type="text" placeholder="Luas Sawah(ha)" class="form-control" value="<?= $traktor->luas_sawah; ?>" name="luas_sawah">
